-- Prestige Homes — importar en Aiven (base defaultdb) para Render
--
-- Pasos con DBeaver:
-- 1. Conectar a defaultdb con los datos de Aiven
-- 2. Archivo → Open SQL Script → este archivo
-- 3. Execute SQL Script (Ctrl+X)
--
-- Admin por defecto: Administrador@gmail.com / Admin123!
