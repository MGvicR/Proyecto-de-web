...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    loginUser($user);
    flash('success', 'Cuenta creada. Ya puedes publicar propiedades.');
    redirect('/vendedor/index.php');
}

renderHeader('Registro', 'auth');
?>
...
<form method="post" class="form-stack">
    ...
    <div class="form-group">
        ...
        <input type="tel" id="telefono" name="telefono" class="js-solo-numeros"
...
<p class="auth-link">¿Buscas rentar? <a href="<?= e(url('/registrarse.php')) ?>">Elige otro tipo de cuenta</a></p>
